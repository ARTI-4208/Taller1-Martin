...
const apiGatewayUrl = "http://172.24.101.92:30506/apps"; //direcciOn IP y el puerto donde se estA ejecutando el servicio del apigateway
console.log("Registering microservice of insumos " + apiGatewayUrl);
requestify.request(apiGatewayUrl, {
    method: "POST",
    body: {
        "appName": "microsvinsumos",
        "hostName": "172.31.9.84", //direcciOn ip del worker donde se estA ejecutando el microservicio
